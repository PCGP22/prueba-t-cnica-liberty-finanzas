function Pagination({
  ...
  let pagesButtons = [2, 3, 4, 5, 6]; //First, it initializes the pagination buttons to the first 6 numbers except for the number 1
  if (currentPage === 1 || currentPage === 2 || currentPage === 3) {
    pagesButtons = [2, 3, 4, 5, 6]; //while the current page stays on the first three pages, show all first 6
  }
  if (currentPage >= 4) {
