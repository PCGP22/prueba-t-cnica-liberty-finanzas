function Pagination({
  ...
  //The reason it doesn't show the first page is because the first and last page buttons are always shown
  ...
  if (
    ...
    //The reason it doesn't show the last page is because the first and last page buttons are always shown
    pagesButtons = [
      maxPages - 5,
      maxPages - 4,
      maxPages - 3,
